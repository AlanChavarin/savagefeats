...
function HomepageHero() {
  ...
  return (
      <div className='relative w-full bg-fill py-[64px] flex flex-col items-center gap-[96px]' style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.70), rgba(0, 0, 0, 0.70))`}}> 
