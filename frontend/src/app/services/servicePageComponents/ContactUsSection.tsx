...
function ContactUsSection() {
  ...
  return (
    <div id="contactUsSection" className='relative w-full py-[32px] lg:py-[48px] text-white flex flex-col justify-center items-center skew-y-[-3deg] lg:skew-y-[-2deg] bg-custom-dark'>
        ...
        <div id="contactUsForm" className="text-black bg-white p-[16px] flex flex-col gap-[8px] w-[90%] box-shadow skew-y-[3deg] lg:skew-y-[2deg] min-[300px]:max-w-[384px] lg:max-w-[512px] lg:p-[32px] lg:gap-[16px]">
            ...
            <div className='text-[9px] text-center font-bold min-[350px]:text-[13px] lg:text-[16px]'>
                Contact us directly today at: <br/><br/> <span className='text-custom-primary hover:text-custom-primaryHover text-[24px] lg:text-[32px] underline'><a href="mailto:contact@savagefeats.com">contact@savagefeats.com</a></span>
            </div>
