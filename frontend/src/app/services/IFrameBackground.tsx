  ...
  return (<>
    ...
    <div className='overflow-hidden h-[50vw] min-[500px]:h-[55vw] relative hidden min-[1500px]:block'>
      <div className='relative w-[full] pb-[56.25%] translate-y-[-22vw]'>
        <iframe src="https://www.youtube-nocookie.com/embed/R2p1qSTQOck?si=N84jlPMUdwFTjPap&amp;start=9003&autoplay=1&mute=1&controls=0" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" className='absolute w-[100%] h-[180%]'></iframe>
      </div>
