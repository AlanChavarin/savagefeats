import {errorSchema, eventSchema, matchSchema, heroSchema, decklistSchema} from '@/app/schemas/schemas'
import { z } from 'zod'
...
export type decklistSchemaType = z.infer<typeof decklistSchema>
